...
% =========================================================================
% Based on your hemorrhage detection feature extraction framework
...
% =========================================================================
% ANEURYSM DETECTION FOR ALL SLICES (USING YOUR REGION-BASED CODE)
% =========================================================================
fprintf('\n%s\n', repmat('=', 1, 80));
...
for slice_idx = 1:n_slices
    ...
    % Run your aneurysm detection pipeline
    brain_mask = skull_strip_swi_improved(original);
    interior_mask = create_brain_interior_mask(brain_mask, 10);
    [~, region_masks, ~] = split_into_focused_regions(interior_mask, 12);
    
    % Extract vessel properties and detect aneurysms using your region-based code
...
for slice_idx = 1:n_slices
    ...
    % =========================================================================
    % VESSEL EXTRACTION (USING YOUR REGION-BASED APPROACH)
    % =========================================================================
...
% =========================================================================
% ANEURYSM DETECTION FUNCTION (WRAPPER FOR YOUR REGION-BASED CODE)
% =========================================================================
...
function brain_mask = skull_strip_swi_improved(mri_image)
    ...
    % FIX: Check if any components exist
    if CC.NumObjects == 0
